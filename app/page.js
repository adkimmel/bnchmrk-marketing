...
export default async function HomePage() {
  ...
  const structuredData = {
    ...
    description: `Employee benefits benchmarking platform with data from ${employerCount.employer_count.toLocaleString()} employers and ${totalPlanCount.toLocaleString()} benefit plans.`,
    offers: {
      "@type": "Offer",
      price: "349",
      priceCurrency: "USD",
